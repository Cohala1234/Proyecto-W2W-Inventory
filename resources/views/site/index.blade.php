    ...
    <div class="card">
        <div class="card-body">
                            ...
                            <div class="modal-body">
                                @csrf
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="inputNanme4" name="nameSite">
                                    </div>
                            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @foreach($site as $siteN)
                    <tr>
                        <td>{{$siteN->nameSite}}</td>
                        <td>
                            <a href="{{ url('/site/'.$siteN->id.'/edit') }}"><button type="button" class="btn btn-warning">Editar</button></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
